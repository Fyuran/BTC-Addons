...
#include "idcs.inc"
#define SELF (compile preprocessFileLineNumbers "BTCScripts\Client\database\shop\gui\scripts\RscDisplayCheckout.sqf")
#define MONEYGREEN [0.13,0.42,0.16,1]
/*DEBUG
#define TER_fnc_getItemValues (compile preprocessFileLineNumbers "BTCScripts\Client\database\shop\fnc\fn_getItemValues.sqf")
#define TER_fnc_resetTimer (compile preprocessFileLineNumbers "BTCScripts\Client\database\shop\fnc\fn_resetTimer.sqf")
*/
params ["_mode","_this"];
switch _mode do {
	case "onLoad":{
