...
#define STRSELF #SELF
#define MONEYGREEN [0.13,0.82,0.16,1]
#define INF "∞"
#define COL_PIC 0
#define COL_NAME 1
#define COL_COUNT 2
...
switch _mode do {
	case "preInit":{
		...
		//--- Make all functions available in uiNamespace
		{
			...
			_file = format["BTCScripts\Client\database\shop\fnc\fn_%1.sqf", configName _x];
...
*/
	...
	case "buttonBuy":{
		_display = _this select 0;
		_ctrlCheckout = _display displayCtrl IDC_RSCDISPLAYCHECKOUT_CHECKOUT;
		["refresh",[_ctrlCheckout]] execVM "BTCScripts\Client\database\shop\gui\scripts\RscDisplayCheckout.sqf";
	};
	case "buyMouse":{
