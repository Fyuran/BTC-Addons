...
params [ "_object", ["_title","Military Shop"], ["_priority",1.5], ["_condition","alive _this && alive _target"], ["_radius",5] ];
...
_actionID = _object addAction [_title,{
	...
	_arsenalID = _object getVariable ["bis_fnc_arsenal_action",-1];
	if (isNil {_arsenalID}) then {
