...
?	Units spawn when player is near
?	Units killed in earlier engagement will not spawn again
?	Units are deleted when player is not near

?	Advanced features
?	Set unit skills
?	Damage amplifier/nullify
?	Kill counter
?	Add more modded units into EOS
?	Hide/show EOS markers in mission
?	Probability of units showing
...
Installing EOS
?	Download latest version of EOS ?	Click here
?	Extract to desktop
...
Getting Started
?	Place a Gamelogic named SERVER 
...
?	Place a marker (Rectangle or Ellipse) over the area where you want to spawn units. Name it EOSzone1.

?	Open the OpenMe.sqf located inside the ‘eos’ folder. Missions\Missionname\eos\OpenMe.sqf


?	Scroll to the bottom. Copy and paste this code into the OpenMe.sqf
