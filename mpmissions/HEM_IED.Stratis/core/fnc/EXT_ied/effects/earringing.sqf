...
/* ----------------------------------------------------------------------------
Function: btc_EXT_deaf_fnc_earringing
...
Examples:
    (begin example)
        [getPos (allPlayers select 0)] call btc_EXT_deaf_fnc_earringing;
    (end)
...
_players_close = allPlayers select { !([_x] call ace_hearing_fnc_hasEarPlugsIn) };
