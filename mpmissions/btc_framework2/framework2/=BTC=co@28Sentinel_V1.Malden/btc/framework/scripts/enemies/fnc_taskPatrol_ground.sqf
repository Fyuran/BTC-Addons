...
/* ----------------------------------------------------------------------------
Function: CBA_fnc_taskPatrol_ground
Description:
...
Example:
    (begin example)
    [this, getMarkerPos "objective1", 50] call CBA_fnc_taskPatrol_ground
...
private _wppos = [];
private _i = 1;
while {count waypoints _group < _count} do {
