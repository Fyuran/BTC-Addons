...
/* ----------------------------------------------------------------------------
Function: btc_framework_fnc_destroyTrafficModule
...
Examples:
    (begin example)
		[] call btc_framework_fnc_destroyTrafficModule;
    (end)
...
private _module = _trg getVariable [QGVAR(trafficModule), objNull];
...
(_module getVariable [QGVAR(trafficMarkers), []]) apply {deleteMarker _x};
#endif